...
class ProvinceResourceIT {
    ...
    public static Province createEntity(EntityManager em) {
        Province province = new Province().name(DEFAULT_NAME).createdDate(DEFAULT_CREATED_DATE).modifiedDate(DEFAULT_MODIFIED_DATE);
        return province;
    }
    ...
    public static Province createUpdatedEntity(EntityManager em) {
        Province province = new Province().name(UPDATED_NAME).createdDate(UPDATED_CREATED_DATE).modifiedDate(UPDATED_MODIFIED_DATE);
        return province;
    }
    ...
    void createProvince() throws Exception {
        ...
        assertThat(testProvince.getModifiedDate()).isEqualTo(DEFAULT_MODIFIED_DATE);
    }
    ...
    void putExistingProvince() throws Exception {
        ...
        updatedProvince.name(UPDATED_NAME).createdDate(UPDATED_CREATED_DATE).modifiedDate(UPDATED_MODIFIED_DATE);
        ...
        assertThat(testProvince.getModifiedDate()).isEqualTo(UPDATED_MODIFIED_DATE);
    }
    ...
    void fullUpdateProvinceWithPatch() throws Exception {
        ...
        partialUpdatedProvince.name(UPDATED_NAME).createdDate(UPDATED_CREATED_DATE).modifiedDate(UPDATED_MODIFIED_DATE);
